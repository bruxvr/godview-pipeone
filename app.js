...
const appData = {
  companies: [
    {
      ...
      currentUsers: 3,
      users: [
        { id: "u1", name: "João Silva", email: "joao@techcorp.com", role: "Admin", lastLogin: "2025-07-07 14:30", isOnline: true },
        { id: "u2", name: "Maria Santos", email: "maria@techcorp.com", role: "Manager", lastLogin: "2025-07-07 13:15", isOnline: true },
        { id: "u3", name: "Pedro Costa", email: "pedro@techcorp.com", role: "User", lastLogin: "2025-07-07 11:45", isOnline: false }
      ],
      contacts: 15420,
    ...
    },
    {
      ...
      currentUsers: 2,
      users: [
        { id: "u4", name: "Ana Oliveira", email: "ana@techcorp.com", role: "Dev Lead", lastLogin: "2025-07-07 15:00", isOnline: true },
        { id: "u5", name: "Carlos Lima", email: "carlos@techcorp.com", role: "Developer", lastLogin: "2025-07-07 14:20", isOnline: false }
      ],
      contacts: 2890,
    ...
    },
    {
      ...
      currentUsers: 2,
      users: [
        { id: "u6", name: "Lucia Ferreira", email: "lucia@techcorp.com", role: "Marketing Manager", lastLogin: "2025-07-07 12:30", isOnline: true },
        { id: "u7", name: "Roberto Alves", email: "roberto@techcorp.com", role: "Designer", lastLogin: "2025-07-07 13:45", isOnline: true }
      ],
      contacts: 8950,
    ...
    },
    {
      ...
      currentUsers: 2,
      users: [
        { id: "u8", name: "Fernanda Costa", email: "fernanda@techcorp.com", role: "Sales Manager", lastLogin: "2025-07-07 10:15", isOnline: true },
        { id: "u9", name: "Eduardo Silva", email: "eduardo@techcorp.com", role: "Sales Rep", lastLogin: "2025-07-07 11:30", isOnline: false }
      ],
      contacts: 12450,
    ...
    },
    {
      ...
      currentUsers: 2,
      users: [
        { id: "u10", name: "Paula Martins", email: "paula@techcorp.com", role: "QA Lead", lastLogin: "2025-07-07 16:00", isOnline: true },
        { id: "u11", name: "Marcos Rocha", email: "marcos@techcorp.com", role: "QA Tester", lastLogin: "2025-07-07 15:30", isOnline: true }
      ],
      contacts: 450,
    ...
    },
    {
      ...
      currentUsers: 2,
      users: [
        { id: "u12", name: "James Wilson", email: "james@global.com", role: "CEO", lastLogin: "2025-07-06 18:00", isOnline: false },
        { id: "u13", name: "Sarah Johnson", email: "sarah@global.com", role: "CTO", lastLogin: "2025-07-06 17:30", isOnline: true }
      ],
      contacts: 9870,
    ...
    },
    {
      ...
      currentUsers: 2,
      users: [
        { id: "u14", name: "Michael Brown", email: "michael@global.com", role: "Production Manager", lastLogin: "2025-07-07 14:00", isOnline: true },
        { id: "u15", name: "Emma Davis", email: "emma@global.com", role: "Supervisor", lastLogin: "2025-07-07 13:00", isOnline: true }
      ],
      contacts: 3450,
      lastActivity: "2 horas atrás",
      region: "Europa",
    ...
    },
    {
      ...
      currentUsers: 1,
      users: [
        { id: "u16", name: "David Miller", email: "david@global.com", role: "Logistics Manager", lastLogin: "2025-07-04 16:00", isOnline: false }
      ],
      contacts: 1200,
    ...
    },
    {
      ...
      currentUsers: 2,
      users: [
        { id: "u17", name: "Alex Chen", email: "alex@startupxyz.com", role: "Founder", lastLogin: "2025-07-07 12:00", isOnline: false },
        { id: "u18", name: "Lisa Wang", email: "lisa@startupxyz.com", role: "Developer", lastLogin: "2025-07-07 11:00", isOnline: true }
      ],
      contacts: 2340,
    ...
    },
    {
      ...
      currentUsers: 1,
      users: [
        { id: "u19", name: "João Silva", email: "joao.silva@email.com", role: "Owner", lastLogin: "2025-07-07 16:30", isOnline: true }
      ],
      contacts: 150,
      lastActivity: "1 hora atrás",
      region: "Brasil",
  ...
  notifications: [
    { id: "n1", type: "login", message: "João Silva fez login", time: "5 min atrás", read: false },
    { id: "n2", type: "error", message: "Erro de API detectado no endpoint /messages", time: "15 min atrás", read: false },
    { id: "n3", type: "account", message: "TechCorp - Vendas foi limitada", time: "1 hora atrás", read: true },
    { id: "n4", type: "user", message: "Maria Santos atualizou configurações", time: "2 horas atrás", read: true },
    { id: "n5", type: "error", message: "Timeout na API de webhooks", time: "3 horas atrás", read: false },
    { id: "n6", type: "login", message: "Ana Oliveira fez login", time: "4 horas atrás", read: true }
  ],

  logs: [
    { id: "log1", type: "incoming", channel: "whatsapp", clientId: "client_001", message: "Olá, preciso de ajuda!", timestamp: "2025-07-08 16:30", account: "TechCorp" },
    { id: "log2", type: "outgoing", channel: "telegram", clientId: "client_002", message: "Mensagem enviada com sucesso", timestamp: "2025-07-08 16:25", account: "Global" },
    { id: "log3", type: "incoming", channel: "instagram", clientId: "client_003", message: "Status recebido", timestamp: "2025-07-08 16:20", account: "StartupXYZ" },
    { id: "log4", type: "outgoing", channel: "whatsapp", clientId: "client_004", message: "Resposta automática", timestamp: "2025-07-08 16:15", account: "TechCorp" },
    { id: "log5", type: "incoming", channel: "messenger", clientId: "client_005", message: "Nova mensagem recebida", timestamp: "2025-07-08 16:10", account: "Global" },
    { id: "log6", type: "outgoing", channel: "telegram", clientId: "client_006", message: "Notificação enviada", timestamp: "2025-07-08 16:05", account: "StartupXYZ" },
    { id: "log7", type: "incoming", channel: "whatsapp", clientId: "client_007", message: "Pergunta sobre produto", timestamp: "2025-07-08 16:00", account: "TechCorp" },
    { id: "log8", type: "outgoing", channel: "instagram", clientId: "client_008", message: "Story respondido", timestamp: "2025-07-08 15:55", account: "Global" },
    { id: "log9", type: "incoming", channel: "messenger", clientId: "client_009", message: "Feedback do cliente", timestamp: "2025-07-08 15:50", account: "StartupXYZ" },
    { id: "log10", type: "outgoing", channel: "whatsapp", clientId: "client_010", message: "Confirmação de pedido", timestamp: "2025-07-08 15:45", account: "TechCorp" },
    { id: "log11", type: "incoming", channel: "telegram", clientId: "client_011", message: "Solicitação de suporte", timestamp: "2025-07-08 15:40", account: "Global" },
    { id: "log12", type: "outgoing", channel: "instagram", clientId: "client_012", message: "Resposta ao comentário", timestamp: "2025-07-08 15:35", account: "StartupXYZ" },
    { id: "log13", type: "incoming", channel: "whatsapp", clientId: "client_013", message: "Dúvida sobre preços", timestamp: "2025-07-08 15:30", account: "TechCorp" },
    { id: "log14", type: "outgoing", channel: "messenger", clientId: "client_014", message: "Link enviado", timestamp: "2025-07-08 15:25", account: "Global" },
    { id: "log15", type: "incoming", channel: "telegram", clientId: "client_015", message: "Arquivo recebido", timestamp: "2025-07-08 15:20", account: "StartupXYZ" }
  ],
...
function setupEventListeners() {
  ...
  // Account search
  document.querySelector('.account-search').addEventListener('input', handleAccountSearch);
  ...
  document.getElementById('accountTableSearch').addEventListener('input', applyAccountsTableFilters);
  document.getElementById('accountTableSort').addEventListener('change', applyAccountsTableFilters);
  
  // API error filters
  document.getElementById('errorTypeFilter').addEventListener('change', applyApiErrorFilters);
  document.getElementById('errorStatusFilter').addEventListener('change', applyApiErrorFilters);
  document.getElementById('errorEndpointFilter').addEventListener('change', applyApiErrorFilters);
  
  // Chart account filter
  document.getElementById('mtmoAccountFilter').addEventListener('change', updateErrorsChart);
  
  // Log search
  document.getElementById('logTypeFilter').addEventListener('change', resetLogsPagination);
  document.getElementById('logChannelFilter').addEventListener('change', resetLogsPagination);
  document.getElementById('logDateFilter').addEventListener('change', resetLogsPagination);
  document.getElementById('logClientIdFilter').addEventListener('input', resetLogsPagination);
...
function createAccountElement(account, depth) {
  ...
  if (hasChildren) {
    expandButton = `
      <button class="expand-btn ${isExpanded ? 'expanded' : ''}" onclick="toggleAccountExpansion('${account.id}', event)">
  ...
  accountHeader.innerHTML = `
    ...
    <div class="account-info">
      ...
      <div class="account-meta">
        <span class="account-status account-status--${account.status}">${getStatusText(account.status)}</span>
  ...
  if (hasChildren) {
    ...
    childrenContainer.className = `account-children ${isExpanded ? '' : 'collapsed'}`;
...
function selectAccount(account) {
  ...
  const selectedHeader = document.querySelector(`[data-account-id="${account.id}"] .account-header`);
  if (selectedHeader) {
      ...
      <div class="detail-section">
        ...
        <div class="detail-grid">
          ...
          <div class="detail-item">
            ...
            <span class="detail-value">${formatNumber(account.mtmoVolume)}</span>
          </div>
          <div class="detail-item">
...
function applyAccountsTableFilters() {
  const searchTerm = document.getElementById('accountTableSearch').value.toLowerCase();
...
function renderAccountsTable() {
  ...
  filteredAccounts.forEach(account => {
    ...
    row.innerHTML = `
      ...
      <td><span class="type-badge type-badge--${account.type}">${account.type}</span></td>
      <td><span class="account-status account-status--${account.status}">${getStatusText(account.status)}</span></td>
      <td>${formatNumber(account.contacts)}</td>
      <td>${formatNumber(account.mtmoVolume)}</td>
      <td>
        <button class="btn btn--sm btn--secondary" onclick="selectAccount(${JSON.stringify(account).replace(/"/g, '&quot;')})">
          Detalhes
        </button>
      </td>
    `;
...
function applyApiErrorFilters() {
  ...
  const filteredErrors = appData.apiErrors.byEndpoint.filter(error => {
    ...
    const endpointMatch = endpointFilter === 'all' || error.endpoint === endpointFilter;
...
function renderErrorsTable(errors) {
  ...
  errors.forEach(error => {
    ...
    row.innerHTML = `
      ...
      <td>${error.type}</td>
      <td><span class="status status--${error.status === 'critical' ? 'error' : error.status === 'warning' ? 'warning' : 'success'}">${error.status}</span></td>
      <td>${error.errors}</td>
...
function searchLogs() {
  ...
  const clientIdFilter = document.getElementById('logClientIdFilter').value.toLowerCase();
  ...
  filteredLogs = appData.logs.filter(log => {
    ...
    const clientIdMatch = !clientIdFilter || log.clientId.toLowerCase().includes(clientIdFilter);
